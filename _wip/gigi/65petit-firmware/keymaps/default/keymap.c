...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,                                    //
                 ...
                 KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE, KC_SPACE, KC_RALT, MO(1), /**/ KC_LEFT, KC_DOWN, KC_RIGHT), //
...
const uint16_t PROGMEM combo_DMENU[] = {KC_ESC, KC_1, COMBO_END};
