...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(2), KC_SPACE, MO(1), KC_LEFT, KC_DOWN, KC_RIGHT),
    // FOR TEST fn1 et fn2
    ...
    //        _______, KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 , _______, _______, KC_PGUP, KC_SCLN,
    //        _______, _______, _______, _______, _______, _______,                            KC_HOME, KC_PGDN, KC_END),

    [1] = LAYOUT(
        KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL,
        KC_CAPS, _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_SCLN,
        _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_END),
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, KC_F14, _______, _______, _______, _______),
