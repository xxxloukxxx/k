...
KC_LALT , KC_LGUI , KC_SPC , MO(1) , KC_TAB
),

[1]=LAYOUT( 
KC_GRV  , KC_1    , KC_2   , KC_3    , KC_4    , KC_5    , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , KC_DEL   ,
KC_TRNS , KC_TRNS , KC_TRNS, KC_TRNS , KC_TRNS , KC_HOME , KC_PGUP , KC_MINS , KC_EQL  , KC_BSLS , KC_UP   , MO(2)    ,
KC_TRNS , KC_TRNS , KC_TRNS, KC_TRNS , KC_TRNS , KC_END  , KC_PGDN , KC_LBRC , KC_RBRC , KC_LEFT , KC_DOWN , KC_RIGHT ,
