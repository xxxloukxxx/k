...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(                                                                                 //
        ...
        /*  */ _S(KC_Z), _C(KC_X), _A(KC_C), KC_V, KC_B, /* */ KC_B, KC_N, KC_M, _A(KC_COMMA), _C(KC_DOT),
        _S(KC_SLSH),                                                                   //
        /*             */ _C(KC_TAB), _G(KC_ESC), RAISE, /* */ LOWER, _A(KC_BSPC), FN, //
        KC_MUTE),                                                                      //

    [_LOWER] = LAYOUT(                                                                                 //
        /*            */ KC_1, KC_2, KC_3, KC_4, KC_5, /* */ KC_MINS, KC_EQL, ___, KC_UP, ___, KC_DEL, //
        /*            */ KC_6, KC_7, KC_8, KC_9, KC_0, /* */ KC_BSLS, KC_SCLN, KC_LFT, KC_DN, KC_RGT,  //
        /* */ ___, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, /* */ ___, ___, ___, ___, ___, KC_TAB,          //
        /*                           */ ___, ___, ___, /* */ ___, ___, ___,                            //
        KC_MUTE),                                                                                      //

    [_RAISE] = LAYOUT(                                                                                      //
        /*    */ KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, /* */ KC_UNDS, KC_PLUS, ___, ___, ___, KC_TILDE, //
        /* */ KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, /* */ KC_PIPE, KC_COLN, ___, ___, KC_QUOT,       //
        /*                     */ ___, ___, ___, ___, ___, /* */ KC_LCBR, KC_RCBR, ___, ___, ___, KC_GRV,   //
        /*                               */ ___, ___, ___, /* */ ___, ___, ___,                             //
        KC_MUTE),                                                                                           //

    [_FN] = LAYOUT(                                                                                       //
        /*   */ KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, /* */ KC_PSCR, KC_SCRL, ___, KC_PAUS, KC_INS, KC_CAPS, //
        /*  */ KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, /* */ KC_F11, KC_F12, ___, ___, ___,                   //
        /* */ KC_MUTE, KC_VOLD, KC_VOLU, ___, ___, /* */ ___, ___, ___, ___, ___, ___,                    //
        /*                       */ ___, ___, ___, /* */ ___, ___, ___,                                   //
        KC_MUTE),                                                                                         //
};
...
const uint16_t PROGMEM combo_pgu[] = {KC_I, KC_P, KC_UP, COMBO_END};
