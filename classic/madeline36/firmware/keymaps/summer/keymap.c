...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT(                                                               //
        ...
        /* KC_LCTL, KC_LALT, LGUI_T(KC_SPACE), LT(NAV, KC_SPACE), MO(FN), KC_RSFT      // */
        ),                                                                           //
...
const uint16_t PROGMEM combo_pgup2[] = {KC_LEFT, KC_RIGHT, KC_UP, COMBO_END};
const uint16_t PROGMEM combo_pgup3[] = {KC_DEL, KC_BACKSPACE, KC_UP, COMBO_END};
