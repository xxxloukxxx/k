...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT(                                                                        //
        ...
        LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, LT(SYM, KC_SLSH), //
    ...
    [SYM] = LAYOUT(                                                                         //
        KC_GRV, KC_QUOT, LSFT(KC_6), LSFT(KC_LBRC), LSFT(KC_RBRC), ___, ___, ___, ___, ___, //
        ___, ___, ___, KC_LPRN, KC_RPRN, ___, ___, ___, ___, ___,                           //
        ___, ___, ___, KC_LBRC, KC_RBRC, ___, ___, ___, ___, ___,                           //
        ___, ___, ___, ___, ___, ___                                                       //
        ),                                                                                  //
};
...
const uint16_t PROGMEM combo_pgup[] = { KC_DEL, KC_BACKSPACE, KC_UP, COMBO_END };
