...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT(
        TD(ESCTD), KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P,
        KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_ENT,
        LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_TAB, KC_N, KC_M, KC_SLSH, KC_RSFT,
        KC_LCTL, TD(GUITD), LT(SYM, KC_SPACE), LT(NAV, KC_SPACE), MO(FN), KC_LALT),
    ...
    [NAV] = LAYOUT(
        ...
        KC_GRV, KC_QUOT, LSFT(KC_6),___, KC_PGUP, KC_LEFT, KC_DOWN,KC_UP, KC_RIGHT,KC_DEL,
        ___, ___, ___, ___, KC_PGDN, ___,KC_HOME,KC_END, ___, KC_BACKSPACE,
        ___, ___, ___, ___, ___, ___),
    ...
    [SYM] = LAYOUT(
        ...
        KC_GRV, KC_QUOT, LSFT(KC_6), ___, ___, KC_BSLS, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC,
        ___, ___, ___, ___, ___, ___, KC_COMM, KC_DOT, KC_SCLN, KC_QUOT,
        ___, ___, ___, ___, ___, ___)
