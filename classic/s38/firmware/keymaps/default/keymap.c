...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT(                                                               //
        ...
        KC_LCTL, KC_LALT, KC_LGUI, LT(NAV, KC_SPACE), KC_RALT, MO(FN), KC_RSFT       //
        ),                                                                           //

    [NAV] = LAYOUT(                                                                      //
        KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_UP, KC_LBRC, KC_RBRC, KC_BSPC, //
        KC_6, KC_7, KC_8, KC_9, KC_0, KC_SCLN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_QUOT,      //
        _____, _____, _____, _____, _____, _____, _____, _____, _____, KC_BSLS,          //
    ...
    [FN] = LAYOUT(                                                                      //
        ...
        _____, _____, _____, _____, _____, _____, KC_PSCR, KC_SCRL, KC_PAUS, KC_CAPS,   //
        _____, _____, _____, _____, _____, _____, _____                                 //
        ),                                                                              //
};
...
const uint16_t PROGMEM combo_pgup[] = {KC_EQL, KC_UP, KC_LBRC, COMBO_END};
