...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT(                                                                     //
        KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_UP, KC_LBRC, KC_RBRC, KC_DEL, //
        KC_6, KC_7, KC_8, KC_9, KC_0, _____, KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSLS,       //
        _____, _____, _____, _____, _____, _____, _____, _____, _____, KC_SCLN, _____,  //
