...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(                                    //
        KC_BSP, KC_NUML, KC_P7, KC_P8, KC_P9, KC_PSLS,  //
        KC_DEL, _______, KC_P4, KC_P5, KC_P6, KC_PAST,  //
        ______, MO(FNC), KC_P1, KC_P2, KC_P3, KC_PMNS,  //
        KC_ENT, KC_P0, _____, KC_PDOT, KC_PPLS, MO(NAV) //
        ),                                              //

    [NAV] = LAYOUT(                             //
        ___, ____, ______, _____, _______, ___, //
        ___, ____, KC_HOM, KC_UP, KC_END, ___,  //
        ___, ____, KC_LFT, KC_DN, KC_RGT, ___,  //
        ___, ____, ______, _____, ______, ___   //
        ),                                      //
...
const uint16_t PROGMEM combo_esc[] = { KC_P0, KC_ENT, COMBO_END };
...
const uint16_t PROGMEM combo_rst[] = { KC_P7, KC_P8, KC_P9, KC_NUML, KC_BSP, COMBO_END };
//
combo_t key_combos[] = {
