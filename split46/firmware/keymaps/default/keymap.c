...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M,  KC_QUOT, KC_LEFT, KC_DOWN, KC_RIGHT,
        KC_LCTL, KC_LALT, KC_LGUI, MO(2), KC_SPACE, KC_SPACE, MO(1),  KC_SLSH,KC_COMM, KC_DOT),

    [1] = LAYOUT(
        KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL,
        KC_CAPS, ___, ___, ___, ___, ___, ___, KC_MINS, KC_EQL, ___,     KC_PGUP, KC_BSLS,
        ___,     ___, ___, ___, ___, ___, ___, ___,     ___,    KC_HOME, KC_PGDN, KC_END,
        ___, ___, ___, ___, ___, ___, ___, KC_SCLN,KC_LBRC, KC_RBRC ),

    [2] = LAYOUT(
        KC_F13, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_INS,
        KC_CAPS, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_MSTP, ___, ___, ___, KC_F11, KC_F12, TO(3),
        ___, KC_PSCR, KC_SCRL, KC_PAUS, ___, ___, ___, ___, ___, ___, ___, ___,
        ___, ___, ___, ___, KC_F14, ___, ___, ___, ___, ___),
    ...
    [3] = LAYOUT(
        ...
        ___, ___, KC_0, KC_ENT, ___, ___, ___, ___, ___, ___),
